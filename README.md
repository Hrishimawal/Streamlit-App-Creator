...
- `ARM_CLIENT_ID`: The Client ID that is used for resource deployment
- `ARM_CLIENT_SECRET`: The Client Secret that is used for resource deployment
- `ARM_TENANT_ID`: The Tenant ID that is used for resource deployment
